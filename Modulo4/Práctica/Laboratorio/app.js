...
document.getElementById("subtraction").addEventListener("click", ifresultsubtraction);
document.getElementById("multiplication").addEventListener("click", ifresultmultiplication);
document.getElementById("division").addEventListener("click", ifresultdivision);
